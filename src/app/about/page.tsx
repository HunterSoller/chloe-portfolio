          ...
          <section className="py-16 sm:py-24">
            <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-12 md:gap-14">
              ...
              <div className="md:col-span-7 md:flex md:justify-end">
                <p className="max-w-[600px] text-[16px] leading-[1.85] text-[#444] sm:text-[18px]">
                  I am an architecture student at the Syracuse University School
                  of Architecture pursuing my B.Arch degree. I am interested in
                  how design can shape the way people experience and move
                  through space. My work explores the relationship between
                  structure, material, and perception, with a focus on creating
                  environments that are both engaging and responsive. Through a
                  range of design explorations, I investigate how architecture
                  can move beyond static form to guide interaction and create
                  meaningful spatial experiences. I am particularly interested
                  in urban, commercial and residential designs while also
                  integrating sustainable strategies that enhance both
                  environmental performance and the lived experience of a space.
                </p>
              </div>
            </div>
          </section>
